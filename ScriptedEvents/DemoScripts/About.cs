...
# All scripts in the Scripts folder can be loaded and executed by running ""script ex [filename]"" or ""run [filename]"" in-game (without the .txt extension).
...
# The majority of this plugin's features are documented through the ""shelp"" server console command. Simply type ""shelp"" in your server console to get started!
